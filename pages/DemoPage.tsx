             ...
             <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 pt-8 pb-6 px-4 sm:px-6 lg:px-8 sticky top-0 z-20">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">Try CareerVivid</h1>
                            <p className="text-lg text-gray-600 dark:text-gray-400 mt-2 max-w-2xl">
                                Experience the power of AI-driven career tools. Select a role to generate a tailored resume or practice an interview instantly.
                            </p>
                        </div>
