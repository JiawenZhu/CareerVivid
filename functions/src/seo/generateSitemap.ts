...
const STATIC_ROUTES = [
    ...
    { loc: `${BASE_URL}/extension-welcome`, changefreq: "weekly", priority: "0.8" },
    { loc: `${BASE_URL}/partners`, changefreq: "weekly", priority: "0.8" },
    { loc: `${BASE_URL}/partners/agency`, changefreq: "weekly", priority: "0.8" },
    { loc: `${BASE_URL}/partners/business`, changefreq: "weekly", priority: "0.7" },
    { loc: `${BASE_URL}/partners/academic`, changefreq: "weekly", priority: "0.7" },
    { loc: `${BASE_URL}/partners/hiring`, changefreq: "weekly", priority: "0.7" },
    { loc: `${BASE_URL}/partners/students`, changefreq: "weekly", priority: "0.7" },
    { loc: `${BASE_URL}/partners/apply`, changefreq: "weekly", priority: "0.6" },
    { loc: `${BASE_URL}/topic/ai-job-search-workspace`, changefreq: "weekly", priority: "0.8" },
    { loc: `${BASE_URL}/topic/chrome-extension-job-autofill`, changefreq: "weekly", priority: "0.8" },
    { loc: `${BASE_URL}/topic/ai-resume-builder-job-tracker`, changefreq: "weekly", priority: "0.8" },
