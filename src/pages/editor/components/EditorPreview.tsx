            ...
            <AnimatePresence>
                {hasOverflow && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className={`sticky top-0 z-30 bg-amber-50 border-b border-amber-200 px-4 py-3 flex items-center justify-center gap-3 shadow-sm transition-opacity duration-200 ${isAnyDropdownOpen ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
                    >
