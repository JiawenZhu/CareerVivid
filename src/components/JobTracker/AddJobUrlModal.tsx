...
const AddJobModal: React.FC<AddJobModalProps> = ({ onClose, onJobAdded }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!description.trim() || !currentUser) {
            setError('Please paste a job description to track.');
            return;
        }
        ...
        try {
            ...
            setError(err.message || 'Failed to process the job description. A manual entry has been created.');
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-2xl">
                <header className="p-4 border-b dark:border-gray-700 flex justify-between items-center">
                    <h2 className="text-xl font-bold">Track a New Job Application</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6">
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                        Paste the complete job description below. Our AI will intelligently extract key details like the job title and company to get you started.
                    </p>
                    ...
                    <div className="mt-6 flex justify-end">
                        ...
                        >
                            ...
                            {isLoading ? 'Analyzing...' : 'Analyze & Track Job'}
                        </button>
                    </div>
                </form>
            </div>
