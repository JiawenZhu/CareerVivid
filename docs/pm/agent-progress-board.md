...
| Task ID | Priority | Task | Acceptance Criteria | Likely Files |
|---|---:|---|---|---|
| EMAIL-001 | P0 | Implement first-job-saved lifecycle | Email uses real job and CTA, suppressible by preferences | `functions/src/emailDataBinding.ts`, `functions/src/emailPolicy.ts` |
| EMAIL-002 | P0 | Implement review-completed lifecycle | Email routes to real resume editor and suggestions | `functions/src/emailDataBinding.ts` |
...
| Task ID | Priority | Task | Acceptance Criteria | Likely Files |
|---|---:|---|---|---|
| SHARE-001 | P0 | Shared resume performance QA | Public shared resume opens quickly on desktop/mobile | `src/pages/PublicResumePage.tsx`, `functions/src/publicResumeApi.ts` |
...
| 2026-05-31 | PERF-001 baseline build | `npm run build` | Passed; existing large chunk warning remains |
